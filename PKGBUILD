...
package() {
  ...
  install -Dm644 electron/settings.html "$appdir/electron/settings.html"
  install -Dm644 electron/settings.css "$appdir/electron/settings.css"
  install -Dm644 electron/settings.js "$appdir/electron/settings.js"
